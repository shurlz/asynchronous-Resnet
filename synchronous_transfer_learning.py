...
def get_features(MODEL, generator, preprocess_input):
...
def breed_checker(img_path):
    ...
    resnet_features = get_features(ResNet50, img_batch, resnet_preprocess)
    xception_features = get_features(Xception, img_batch, xcep_preprocess)
...
print(breed_checker('retriever.png'))
